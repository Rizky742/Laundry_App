                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <a type="button" class="btn btn-outline-primary btn-icon-text" href="tambah_paket.php">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                include "../../connection/koneksi.php";
                                                // $qry_paket = mysqli_query($conn, "select tb_paket.* , tb_outlet.id as id_outlet, tb_outlet.nama from tb_paket , tb_outlet where tb_paket.id_outlet = tb_outlet.id");
                                                $qry_paket = mysqli_query($conn, "select tb_paket.* , tb_outlet.id as id_outlet, tb_outlet.nama from tb_paket , tb_outlet where tb_paket.id_outlet = tb_outlet.id and tb_paket.id_outlet = '".$_SESSION['id_outlet']."'");
                                                $no = 0;
                                                while ($data_paket = mysqli_fetch_array($qry_paket)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="ubah_paket.php?id=<?= $data_paket['id'] ?>&id_outlet=<?= $data_paket['id_outlet'] ?>" class="btn btn-outline-primary btn-fw" style="margin-right: 15px;">Ubah</a><a href="hapus_paket.php?id=<?= $data_paket['id'] ?>" class="btn btn-outline-danger btn-fw">Hapus</a></td>
                                                    </tr>
                                                <?php
                                                }
                                                ?>
