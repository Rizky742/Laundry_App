                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <a type="button" class="btn btn-outline-primary btn-icon-text" href="outlet.php">
                        ...
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Ubah Outlet</h4>
                                    <p class="card-description">
                                        Silahkan merubah Outlet
                                    </p>
                                    <?php
                                    include "../../connection/koneksi.php";
                                    $qry_get_outlet = mysqli_query($conn, "select * from tb_outlet where id = '" . $_GET['id'] . "'");
                                    $dt_outlet = mysqli_fetch_array($qry_get_outlet);
                                    ?>
                                    <form class="forms-sample" method="POST" action="proses_ubah_outlet.php?id=<?= $_GET['id'] ?>">
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">Nama Outlet</label>
                                            <input type="text" name="nama" class="form-control" id="exampleInputUsername1" placeholder="Nama" value="<?= $dt_outlet['nama'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleTextarea1">Alamat</label>
                                            <textarea class="form-control" name="alamat" id="exampleTextarea1" rows="4" placeholder="Alamat"><?= $dt_outlet['alamat'] ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">No Telpon</label>
                                            <input type="text" class="form-control" name="noTelpon" id="exampleInputUsername1" placeholder="No Telpon" value="<?= $dt_outlet['tlp'] ?>">
                                        </div>
