                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-description">
                                        Silahkan menambahkan Outlet
                                    </p>
                                    <form class="forms-sample" method="POST" action="proses_tambah_outlet.php">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="noTelpon" id="exampleInputUsername1" placeholder="No Telpon">
                                        </div>
