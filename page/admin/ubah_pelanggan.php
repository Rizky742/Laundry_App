                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <a type="button" class="btn btn-outline-primary btn-icon-text" href="pelanggan.php">
                        ...
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    ?>
                                    <form class="forms-sample" method="POST" action="proses_ubah_pelanggan.php?id=<?= $_GET['id'] ?>">
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">Nama Pelanggan</label>
                                            <input type="text" name="nama" class="form-control" id="exampleInputUsername1" placeholder="Nama" value="<?= $dt_member['nama'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleTextarea1">Alamat</label>
                                            <textarea class="form-control" name="alamat" id="exampleTextarea1" rows="4" placeholder="Alamat"><?= $dt_member['alamat'] ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">No Telpon</label>
                                            <input type="number" class="form-control" name="noTelpon" id="exampleInputUsername1" placeholder="No Telpon" value="<?= $dt_member['tlp'] ?>">
                                        </div>
                                        <div class="form-group">
