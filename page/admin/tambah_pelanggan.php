                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-description">
                                        Silahkan menambahkan Pelanggan
                                    </p>
                                    <form class="forms-sample" method="POST" action="proses_tambah_pelanggan.php">
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">Nama Pelanggan</label>
                                            <input type="text" name="nama" class="form-control" id="exampleInputUsername1" placeholder="Nama">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleTextarea1">Alamat</label>
                                            <textarea class="form-control" name="alamat" id="exampleTextarea1" rows="4" placeholder="Alamat"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">No Telpon</label>
                                            <input type="number" class="form-control" name="noTelpon" id="exampleInputUsername1" placeholder="No Telpon">
                                        </div>
                                        <div class="form-group">
