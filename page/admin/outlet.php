                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <a type="button" class="btn btn-outline-primary btn-icon-text" href="tambah_outlet.php">
                                            ...
                                            <tbody>
                                                ...
                                                while ($data_outlet = mysqli_fetch_array($qry_outlet)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="ubah_outlet.php?id=<?= $data_outlet['id'] ?>" class="btn btn-outline-primary btn-fw" style="margin-right: 15px;">Ubah</a><a href="hapus_outlet.php?id=<?= $data_outlet['id'] ?>" class="btn btn-outline-danger btn-fw">Hapus</a></td>
                                                    </tr>
                                                <?php
                                                }
                                                ?>
