                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-description">
                                        Silahkan menambahkan Paket
                                    </p>
                                    <form class="forms-sample" method="POST" action="proses_tambah_paket.php">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="exampleFormControlSelect2" name="outlet">
                                                <?php
                                                include "../../connection/koneksi.php";
                                                // $qry_get_outlet = mysqli_query($conn, "select * from tb_outlet where tb_outlet.id");
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="harga" id="exampleInputUsername1" placeholder="Harga">
                                        </div>
