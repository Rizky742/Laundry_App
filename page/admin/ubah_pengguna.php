                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <a type="button" class="btn btn-outline-primary btn-icon-text" href="pengguna.php">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-description">
                                        Silahkan merubah Pengguna
                                    </p>
                                    <?php
                                    include "../../connection/koneksi.php";
                                    $qry_get_user = mysqli_query($conn, "select * from tb_user where id = '" . $_GET['id'] . "'");
                                    $dt_user = mysqli_fetch_array($qry_get_user);
                                    ?>
                                    <form class="forms-sample" method="POST" action="proses_ubah_pengguna.php?id=<?= $_GET['id'] ?>">
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">Nama</label>
                                            <input type="text" name="nama" class="form-control" id="exampleInputUsername1" placeholder="Nama" value="<?= $dt_user['nama'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">Username</label>
                                            <input type="text" name="username" class="form-control" id="exampleInputUsername1" placeholder="Username" value="<?= $dt_user['username'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Password</label>
                                            <input type="password" name="password" class="form-control" id="exampleInputPassword1" placeholder="Password">
                                            <span toggle="#exampleInputPassword1" class="fa fa-fw fa-eye field-icon toggle-password" onclick="showPassword('exampleInputPassword1')" style="cursor: pointer;"></span>
                                            <!-- <input type="checkbox" onclick="showPassword()" style="margin-top: 10px;"> Show Password -->

                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Buat Password Baru</label>
                                            <input type="password" name="newPassword" class="form-control" id="exampleInputPassword2" placeholder="New Password">
                                            <span toggle="#exampleInputPassword2" class="fa fa-fw fa-eye field-icon toggle-password" onclick="showPassword('exampleInputPassword2')" style="cursor: pointer;"></span>
                                        </div>
                                        <div class="form-group">
