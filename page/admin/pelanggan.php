                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <a type="button" class="btn btn-outline-primary btn-icon-text" href="tambah_pelanggan.php">
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Daftar Pelanngan</h4>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                include "../../connection/koneksi.php";
                                                $qry_member = mysqli_query($conn, "select * from tb_member");
                                                $no = 0;
                                                while ($data_member = mysqli_fetch_array($qry_member)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="ubah_pelanggan.php?id=<?= $data_member['id'] ?>" class="btn btn-outline-primary btn-fw" style="margin-right: 15px;">Ubah</a><a href="hapus_pelanggan.php?id=<?= $data_member['id'] ?>" class="btn btn-outline-danger btn-fw">Hapus</a></td>
                                                    </tr>
                                                <?php
                                                }
                                                ?>
