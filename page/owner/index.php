...
<body>
  <div class="container-scroller d-flex">
          ...
          <ul class="navbar-nav mr-lg-2">
            <li class="nav-item nav-search d-none d-lg-block">
              <div class="input-group">
                <h3 style="color: black;">Owner Page</h3>
              </div>
            </li>
          </ul>
          <!-- <ul class="navbar-nav mr-lg-2">
        ...
        <div class="content-wrapper">
          ...
          <form class="forms-sample" method="POST" action="">
            <div class="form-group">
              <label for="exampleSelectGender" style="font-weight: 600;">Pilih Outlet</label>
              <select class="form-control" id="exampleSelectGender" onchange="getSelectValue();" name="outlet">
              <?php
              include "../../connection/koneksi.php";
              $qry_get_outlet = mysqli_query($conn, "select * from tb_outlet");
              while($ambilData = mysqli_fetch_array($qry_get_outlet)){
              ?>
              ...
              <button type="submit" class="btn btn-primary me-2" style="margin-top: 10px;">Submit</button>
            </div>
          </form>
          </div>
          <div class="row">
                      ...
                      <tbody>
                        ...
                        while ($data_transaksi = mysqli_fetch_array($qry_transaksi)) {
                          ...
                          <tr>
                            ...
                            <td><a href="transaksi_detail.php?id=<?= $data_transaksi['id_transaksi'] ?>" class="btn btn-outline-primary btn-fw" style="margin-right: 15px;">Detail</a></td>
                          </tr>
                        <?php
                        }
                        ?>
    ...
    <script>
      ...
      {
        var pilih = document.getElementById('exampleSelectGender').value;
        console.log(pilih);
      }
    </script>
</body>
