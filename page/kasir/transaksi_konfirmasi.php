                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <a type="button" class="btn btn-outline-primary btn-icon-text" href="transaksi.php" style="margin-right: 15px;">
                                            ...
                                            <tbody>
                                                ...
                                                while ($data_transaksi = mysqli_fetch_array($qry_transaksi)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="transaksi_bayar.php?id=<?= $data_transaksi['id_transaksi'] ?>" class="btn btn-outline-primary btn-fw" style="margin-right: 15px;">Pilih</a></td>
                                                    </tr>
                                                <?php
                                                }
                                                ?>
