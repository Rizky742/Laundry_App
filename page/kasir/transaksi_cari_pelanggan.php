                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <a type="button" class="btn btn-outline-primary btn-icon-text" href="transaksi.php">
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Silahkan Pilih Pelanggan</h4>
                                            ...
                                            <tbody>
                                                ...
                                                while ($data_member = mysqli_fetch_array($qry_member)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="tambah_transaksi.php?id=<?= $data_member['id'] ?>" class="btn btn-outline-primary btn-fw" style="margin-right: 15px;">Pilih</a></td>
                                                    </tr>
                                                <?php
                                                }
                                                ?>
