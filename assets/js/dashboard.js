  ...
  $(function() {
    ...
    if ($("#balance-chart").length) {
      var areaData = {
        ...
        datasets: [
          {
            data: [3000, 1400, 2200, 1200, 2300, 2400, 2700, 1200, 2800, 2600, 1250, 1900, 1800, 2800, 2800, 1200, 2500, 2600, 1800, 1200, 2000, 1800, 2700, 1600, 2800, 2000, 2100, 1200, 2000, 1200, 1200, 2500],
            borderColor: [
              '#1faf47'
            ],
            borderWidth: 3,
    ...
    if ($("#balance-chart2").length) {
      ...
      var balanceChartCanvas = $("#balance-chart2").get(0).getContext("2d");
      var balanceChart = new Chart(balanceChartCanvas, {
        type: 'line',
        data: areaData,
        options: areaOptions
    ...
    if ($("#balance-chart3").length) {
      ...
      var balanceChartCanvas = $("#balance-chart3").get(0).getContext("2d");
      var balanceChart = new Chart(balanceChartCanvas, {
        type: 'line',
        data: areaData,
        options: areaOptions
